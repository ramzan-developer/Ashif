...
function Header() {
  return (
    <div className="header1 grid grid-cols-1 md:grid-cols-12 w-full   min-h-screen gap-3 border-b	 rounded-b-[50px] border-[#388053]">
      {/* Left Content */}
      <div className="md:col-span-7 flex flex-col justify-center text-left md:text-left p-6 space-y-6 gap-6">
        <p className="text-[1.2rem] font-bold bg-[#6e7774] text-white rounded-full px-6 py-2 w-60 items-center text-center">
          Post Production Editors
        </p>
        <h2 className="text-[60px] md:text-5xl font-bold">
          Helping podcasts <br />
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div className="flex gap-2">
            <img src={logo} alt="channel logo" className="h-12 w-12" />
            <img src={logo} alt="channel logo" className="h-12 w-12" />
            <img src={logo} alt="channel logo" className="h-12 w-12" />
          </div>
      ...
      {/* Right Video Section */}
      <div className="relative md:col-span-5 flex items-center justify-center p-6 ">
